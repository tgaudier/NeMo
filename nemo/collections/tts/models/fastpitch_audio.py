...
from nemo.collections.tts.modules.fastpitch_audio import FastPitchModule
...
class FastPitchAudioModel(ModelPT, Exportable, FastPitchAdapterModelMixin):
    ...
    def __init__(self, cfg: DictConfig, trainer: Trainer = None):
        ...
        if self.learn_alignment:
            ...
            input_fft_kwargs["n_embed"] = cfg.get("input_dim", 1024)
        ...
        self.export_config = {
            "emb_range": (0, self.fastpitch.encoder.word_emb.out_features),
            "enable_volume": False,
    ...
    @typecheck(
        input_types={
            "text": NeuralType(('B', 'T_text', 'D'), EncodedRepresentation()),
